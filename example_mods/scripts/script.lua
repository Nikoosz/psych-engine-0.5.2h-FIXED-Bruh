...
local xx = 450; -- Code to change the position of the camera to the left or right for your opponent, Less = Left (They can be negative numbers), More = Right
...
local xx2 = 420; -- Same code as above, but for boyfriend left, right
local yy2 = 290; -- Same code as above, but for boyfriend up, down
local xx3 = 450; -- Same code as above, but for girlfriend left, right
local yy3 = 300; -- Same code as above, but for girlfriend, up, down
local ofs = 85; -- Code to adjust the intensity with which the camera moves, the more numbers, the more intense, and the fewer numbers, less intense
